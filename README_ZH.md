...
- **开发工具安装器 (`install-dev-tool`)** — 交互式菜单，可安装 Go、Node.js、OrbStack、VSCode、Python、Claude、Rust、Git、MongoDB Compass、DBeaver 和 Google Chrome。用方向键选择即可。
...
- 桌面应用（VSCode、Claude、OrbStack、MongoDB Compass、DBeaver、Google Chrome）会自动下载并放入 `/Applications`。
