...
- **Dev Tools Installer (`install-dev-tool`)** — An interactive menu to install Go, Node.js, OrbStack, VSCode, Python, Claude, Rust, Git, MongoDB Compass, DBeaver, and Google Chrome. Navigate with arrow keys, pick what you need.
...
- Desktop apps (VSCode, Claude, OrbStack, MongoDB Compass, DBeaver, Google Chrome) are downloaded and placed in `/Applications` automatically.
