...
- **Cài đặt công cụ lập trình (`install-dev-tool`)** — Menu tương tác để cài Go, Node.js, OrbStack, VSCode, Python, Claude, Rust, Git, MongoDB Compass, DBeaver, và Google Chrome. Chọn bằng phím mũi tên.
...
- Ứng dụng desktop (VSCode, Claude, OrbStack, MongoDB Compass, DBeaver, Google Chrome) tự động tải về và đặt vào `/Applications`.
